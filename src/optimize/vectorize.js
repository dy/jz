...
import { _isAddressLocal, _isPixelIndexLocal, _offsetLocalStride, constNum, firstAccess, hasBranchOrReturn, hasGlobalSet, hasImpureCall, hasSideEffect, isI32Const, isLocalGet, matchConstMulIV, matchInc1, matchIncN, matchLaneAddr, matchLaneOffset, matchMirrorAddr } from './vectorize/addr-model.js'
import { aosAddrPair, aosGather, aosStore, getOrAllocLanedLocal } from './vectorize/aos.js'
