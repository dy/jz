...
import { isProfitable } from './vectorize/cost-model.js'
...
import { LANE_COMPARE, LANE_INFO, LANE_PURE, LOAD_OPS, MINMAX_CVT, MINMAX_WIDEN, PPC_CALL2, REDUCE_CANON, REDUCE_OP_LOOKUP, STORE_OPS, WIDEN_LOADS } from './vectorize/lane-tables.js'
