...
import { _isAddressLocal, _isPixelIndexLocal, _offsetLocalStride, assertBodyModelSound, buildBodyModel, collectReferencedNames, collectWrites, constNum, firstAccess, hasBranchOrReturn, hasGlobalSet, hasImpureCall, hasSideEffect, isI32Const, isLocalGet, matchConstMulIV, matchExitBrIf, matchInc1, matchIncN, matchLaneAddr, matchLaneOffset, matchMirrorAddr } from './vectorize/addr-model.js'
import { F64_TO_F32X4, INT_WIDEN_F32, LANE_COMPARE, LANE_INFO, LANE_PURE, LOAD_OPS, MINMAX_CVT, MINMAX_WIDEN, PPC_CALL2, REDUCE_CANON, REDUCE_OP_LOOKUP, STORE_OPS, WIDEN_LOADS } from './vectorize/lane-tables.js'
import { f64Zero, forEachLocalDef, isArr, isSplatConst, localGetName } from './vectorize/node-utils.js'
