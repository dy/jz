...
import { constNum, firstAccess, hasGlobalSet, hasImpureCall, isI32Const, isLocalGet, matchInc1, matchIncN } from './vectorize/addr-model.js'
...
import { CMP_LANE, bumpPixelIV, epilogueIsSafe, matchOuterPixelLoop, rampPixelIV, readsVar, writesName } from './vectorize/outer-scaffold.js'
import { tryPerPixelColor } from './vectorize/per-pixel-color.js'
