/**
 * Sparse-map-read fusion pass: fuseSparseMapReads (entry) + tryFuseInBlock/tryFusePair
 * (matchers) + purity/shape predicates + substSparse/cloneAndBind (rewrite) — fully
 * self-contained, called once per function from prepare() and nothing else.
 *
 * @module prepare/sparse-map
 */
