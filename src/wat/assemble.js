...
// Stdlib template parse cache + realize/reachability/pull. Moved to
// assemble/stdlib-pull.js (pipeline-minimality split); re-exported here so
// every existing `from '../wat/assemble.js'` import keeps working.
export { clearStdlibParseCache, stdlibParseCacheMap, setStdlibParseCacheMap } from './assemble/stdlib-pull.js'
// optimizeModule (below, not yet split out) calls this directly — a genuine
// cross-seam edge (.work/assemble-outliers.md §3), not leftover coupling.
import { appendLateStdlib } from './assemble/stdlib-pull.js'
...
// Synthetic `$__start` function build + later simplification. Moved to
// assemble/start-fn.js (pipeline-minimality split); re-exported here so
// every existing `from '../wat/assemble.js'` import keeps working.
...
// Stdlib reachability + late vectorizer top-up + main pull-and-decide-
// memory/allocator phase + import sync. Moved to assemble/stdlib-pull.js
// (pipeline-minimality split); re-exported here so every existing
// `from '../wat/assemble.js'` import keeps working.
export { appendLateStdlib, pullStdlib, syncImports } from './assemble/stdlib-pull.js'
/**
