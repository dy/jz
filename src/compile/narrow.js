...
import {
  scanBoundedLoops, exprType, typedElemCtor, typedStaticLen, intLevelMap,
} from '../type.js'
...
import { PTR_ABI_KINDS, RECUR_INT_OPS, assertValKindConsistent, filterLiveCallSites, buildCallerTypedLenCtx, enrichCallerValTypesFromPointerParams, resetParamWasmFacts, createPhaseState, buildCallerTypedCtx, buildCallerCtx } from './narrow/caller-ctx.js'
