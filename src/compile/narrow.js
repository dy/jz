...
import {
  ctx, warn, err, DBG_INVARIANTS,
} from '../ctx.js'
import {
  withCurrentFunction, withFunctionFields, withTypedElemOverlay, withTypedElems,
} from './flow-state.js'
import { warningsView } from '../session-views.js'
import {
  isBlockBody, alwaysReturns, hasBareReturn, returnExprs, callArgs, ASSIGN_OPS, extractParams, classifyParam, PARAM_KIND, PARAM_NAME, refsName, carriesName, REFS_THROUGH_ARROWS, walkAst, some,
} from '../ast.js'
import { isLiteralStr, I32_MIN, I32_MAX } from '../ir.js'
import {
  analyzeBody, findMutations, reanalyzeBody, invalidateBodies, mayBeNullish,
} from './analyze.js'
import {
...
import {
  scanBoundedLoops, exprType, typedElemCtor, typedStaticLen,
} from '../type.js'
import { typedElemAux, ctorFromElemAux } from '../../layout.js'
import { observeProgramSlots } from './program-facts.js'
import {
  valTypeOf, valTypeOfWithLocals, hasAmbiguousBoolMerge, exprMayBeUndefinedIn, exprPresentValIn,
} from '../kind.js'
import { typedCtorElemValType } from '../kind-traits.js'
import {
  VAL, updateRep, lookupValType, KIND_UNIVERSE,
} from '../reps.js'
import {
  paramFactsOf, ensureParamRep, mergeParamFact, joinKinds, latticeMeet,
} from '../param-reps.js'
import {
  inferArrElemSchema, inferArrElemSchemaSet, inferArrElemValType, inferSchemaId, inferValType, inferTypedCtor, inferParams,
} from './infer.js'
import { materializeVariant } from './variant.js'
import { RECUR_INT_OPS, assertValKindConsistent, filterLiveCallSites, buildCallerTypedLenCtx, enrichCallerValTypesFromPointerParams, resetParamWasmFacts, createPhaseState, buildCallerTypedCtx, buildCallerCtx } from './narrow/caller-ctx.js'
import { applyI32ParamSpecialization, validateTypedLenParams, validateIntConstParams, applyPointerParamAbi, narrowableFuncs, applyTypedPointerParamAbi } from './narrow/param-abi.js'
...
function arrayReadProvenInBounds(readNode, callerFunc, paramReps) {
