...
import {
  returnExprs, ASSIGN_OPS, extractParams, classifyParam, PARAM_KIND, PARAM_NAME, REFS_THROUGH_ARROWS, walkAst, some,
} from '../ast.js'
import { isLiteralStr, I32_MIN, I32_MAX } from '../ir.js'
import { analyzeBody, mayBeNullish } from './analyze.js'
...
import { inferInternalArrayLengths, arrayReadProvenInBounds, inferTypedValueRanges } from './narrow/summaries.js'
