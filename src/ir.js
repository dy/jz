...
export { bigintStrict, bigintEraseErr, boxBigInt, deferBigintBox, materializeDeferredBigint, unboxBigInt, applyBigintRepresentationAction, maybeUnboxBigInt, isSchemaSlotBigintPossible, isTernaryBoxedBigint, isPlanTaggedBigint, isPlanRawBigint, readI64MayUnbox, readI64 } from './ir/bigint.js'
...
export { NULL_NAN, UNDEF_NAN, TOMB_NAN, BOOL_ATOM_BASE, FALSE_NAN, TRUE_NAN, NULL_WAT, UNDEF_WAT, NULL_IR, UNDEF_IR, FALSE_IR, TRUE_IR, nullExpr, undefExpr, boolBoxIR, nullableBoolBoxIR, carrierF64, carrierF64Narrow, unboxBoolIR, isNullish, isUndef, isNull, throwTypeErrorIR, isBoolAtom, truthyIR, toBoolFromEmitted } from './ir/sentinels.js'
