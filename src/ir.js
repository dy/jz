...
export { bigintStrict, bigintEraseErr, boxBigInt, unboxBigInt, applyBigintRepresentationAction, maybeUnboxBigInt, isSchemaSlotBigintPossible, isTernaryBoxedBigint, isPlanTaggedBigint, isPlanRawBigint, readI64MayUnbox, readI64 } from './ir/bigint.js'
