...
export const examples = [
  ...
  { name: 'spectra',      title: 'Spectra',           blurb: 'eigenvalues of a stream of random 6×6 matrices — Bohemian lace melts into a spectral cloud' },
  ...
  { name: 'waves',        title: 'Waves',             blurb: 'a calm swimming pool folding sunlight — real refractive caustics from the 2D wave equation', show: true },
  ...
  { name: 'plume',        title: 'Plume',             blurb: 'seven lines of trig unfold 40k points into rainbow feathers — tweet-sized generative art', show: true },
