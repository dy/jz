...
<img src="bench/bench.svg?v=4" alt="jz vs alternatives — geometric mean speed across the bench corpus; native C and Rust shown as reference, jz = 1.00× baseline" width="720">
