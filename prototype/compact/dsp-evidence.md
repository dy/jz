...
- compact compiler: 2,257,243 bytes
- current full compiler: 14,451,722 bytes
- compiler artifact ratio: 6.40x smaller
- typed row compile speedup: 16.00x
- typed row output: 287 bytes versus production's 568 bytes
- overall compile-speed geomean: 41.35x
