...
Latest loaded-machine result against the fresh 14,530,671-byte `dist/jz.wasm`:

- staged compiler: 2,256,498 bytes, 6.44x smaller
- staged source graph: 72 modules, 1,016,838 source bytes
- compile-speed geomean: 41.03x
- minimum compile speedup: 4.44x
...
- the typed SIMD row compiles 14.84x faster and emits 287 bytes versus production's 568 bytes
