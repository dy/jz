...
Latest loaded-machine result against the fresh 14,480,545-byte `dist/jz.wasm`:

- staged compiler: 2,256,496 bytes, 6.42x smaller
- staged source graph: 72 modules, 1,016,513 source bytes
- compile-speed geomean: 37.81x
- minimum compile speedup: 4.21x
...
- the typed SIMD row compiles 12.72x faster and emits 287 bytes versus production's 568 bytes
