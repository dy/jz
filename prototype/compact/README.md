...
Latest loaded-machine result against the fresh 14,415,726-byte `dist/jz.wasm`:

- staged compiler: 2,234,176 bytes, 6.45x smaller
- staged source graph: 72 modules, 1,016,838 source bytes
- compile-speed geomean: 45.83x
- minimum compile speedup: 6.54x
...
- the typed SIMD row compiles 15.97x faster and emits 287 bytes versus production's 568 bytes
