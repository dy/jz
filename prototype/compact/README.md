...
Latest loaded-machine result against the fresh 14,523,519-byte `dist/jz.wasm`:

- staged compiler: 2,256,528 bytes, 6.43x smaller
- staged source graph: 72 modules, 1,016,838 source bytes
- compile-speed geomean: 41.13x
- minimum compile speedup: 4.48x
...
- the typed SIMD row compiles 14.83x faster and emits 287 bytes versus production's 568 bytes
