...
Latest loaded-machine result against the fresh 14,466,780-byte `dist/jz.wasm`:

- staged compiler: 2,256,496 bytes, 6.41x smaller
- staged source graph: 72 modules, 1,016,523 source bytes
- compile-speed geomean: 37.75x
...
- the typed SIMD row compiles 13.28x faster and emits 287 bytes versus production's 568 bytes
