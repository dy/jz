...
const KERNEL_EXCLUDE = new Set(['imports', 'external', 'cli', 'timers', 'wasi', 'watr', 'warnings', 'perf-ratchet', 'wat-invariants', 'slp', 'cond-vectorize', 'unswitch-typed-param', 'selfhost-source', 'abi', 'examples'])
