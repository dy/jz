const TESTS = [
  ...
  'speculate',
  'unsigned',
  'sequence-values', 'bigint-division', 'bigint-tag',
  'perf',
  'timers',
  'invariants',
  'refactor-oracle',
...
const KERNEL_EXCLUDE = new Set(['imports', 'external', 'cli', 'options', 'web-smoke', 'snapshot', 'timers', 'wasi', 'watr', 'warnings', 'perf-ratchet', 'unswitch-typed-param', 'bench-c', 'native-lowering', 'kernel-parity', 'kernel-oracle',
  ...
  'never-grown',
  'self-compile-source', 'self-compile-includes', 'self-checkpoint', 'abi', 'examples', 'bench-porffor', 'bench-perry',
...
const LEG_INVARIANT = new Set([
  ...
  'reachability-mutants', 'bench-c', 'bench-porffor', 'bench-perry', 'bench-svg', 'cli', 'native-lowering',
