...
const WASM_TODO = {
  sdf:      'jz 1.28× c-wasm (f1e877b8 evidence). DISSECTED with shares (ledger 2026-07-25): the edt1d hull-cursor k-guards are ~53% of the gap — the research-tier symbolic hull (sentinel invariant z[0]=-INF blocks k-- below 0; relational elem hull v[i] ∈ [0, n-1] with runtime n). Length-header LICM landed (V8-neutral, size win). The residual is the hard research tail; no mechanical lever remains.',
