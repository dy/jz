...
export default (ctx) => {
  ...
  ctx.core.stdlib['__atomics_addr'] = `(func $__atomics_addr (param $arr i64) (param $i i32) (result i32)
    (if (i32.or
      ...
      (then (global.set $__jz_last_err_bits (i64.reinterpret_f64 (f64.const ${errorCodeLiteral(ERR.ATOMICS_RECEIVER32)}))) (throw $__jz_err (f64.const ${errorCodeLiteral(ERR.ATOMICS_RECEIVER32)}))))
    (if (i32.ge_u (local.get $i) (call $__len (local.get $arr)))
      (then (global.set $__jz_last_err_bits (i64.reinterpret_f64 (f64.const ${errorCodeLiteral(ERR.ATOMICS_INDEX32)}))) (throw $__jz_err (f64.const ${errorCodeLiteral(ERR.ATOMICS_INDEX32)}))))
  ...
  ctx.core.stdlib['__atomics_addr64'] = `(func $__atomics_addr64 (param $arr i64) (param $i i32) (result i32)
    (if (i32.or
      ...
      (then (global.set $__jz_last_err_bits (i64.reinterpret_f64 (f64.const ${errorCodeLiteral(ERR.ATOMICS_RECEIVER64)}))) (throw $__jz_err (f64.const ${errorCodeLiteral(ERR.ATOMICS_RECEIVER64)}))))
    (if (i32.ge_u (local.get $i) (call $__len (local.get $arr)))
      (then (global.set $__jz_last_err_bits (i64.reinterpret_f64 (f64.const ${errorCodeLiteral(ERR.ATOMICS_INDEX64)}))) (throw $__jz_err (f64.const ${errorCodeLiteral(ERR.ATOMICS_INDEX64)}))))
