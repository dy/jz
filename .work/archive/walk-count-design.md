...
`scripts/self.js`, same self-graph every `.work/evidence.md` §Region arena
...
self-build ×2 convergence, same bar every `.work/evidence.md` §Region arena
...
RepPlan v2 (`.work/archive/representation-plan-v2-design.md`, status "design, not
