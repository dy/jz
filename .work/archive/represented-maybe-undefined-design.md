...
Read-only deliverable, companion to the audit-#9 P0-1 disable (.work/archive/todo.md
...
- **The chokepoint list is enumerated, not derived.** Only sites that
  ...
  .work/archive/carrier-invariant-design.md is the same shape of bug (an
...
**The decl-init wall** (.work/archive/carrier-invariant-design.md): a structurally
...
Empirically verified: the audit-#9 5-repro table (.work/archive/todo.md "audit-#9
...
.work/archive/todo.md's outline-pass/localReuse hunts) — this is a new instance of
...
**§5 criteria — per-criterion verdict** (full detail: .work/archive/todo.md's Slice
4 ledger entry):
...
3. dyn-keys.js pins assert JS-correct values LIVE — MET, full matrix
   re-verified (.work/archive/todo.md).
...
trace: .work/archive/todo.md): the NEW call-result arm broke `coerceNullishToNum`'s
...
.work/archive/todo.md's Slice 4 ledger entry.
