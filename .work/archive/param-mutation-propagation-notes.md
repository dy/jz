...
worktree's uncommitted `streamcode-bug-notes.md` "Fix attempt 1: partial", and this
base commit's `.work/archive/literal-method-typed-index-notes.md` bottom section).
