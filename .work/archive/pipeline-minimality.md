...
Source of the mandate: `.work/archive/handoff-2026-08-22.md` (audit 2026-08-26 item 3:
...
- Refactor oracle (scripts/refactor-oracle.mjs, merged to main after this slice was
  ...
  and is the gate for every later slice (`.work/archive/refactor-oracle.md`'s rule).
...
.work/archive/handoff-2026-08-22.md: walkAst callbacks capturing that pass's per-loop
...
3. Outlier functions (re-measured 2026-08-28; the audit's list was partly stale):
   ...
   `.work/archive/narrow-split.md` §6: one mutable `sharedSiteState` shared by ~20 nested
   ...
   (closure matrix in .work/archive/narrow-split.md — hoisting has zero reuse payoff).
