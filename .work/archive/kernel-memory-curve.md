...
byproduct (see `.work/archive/todo.md`, same date, for the fix write-up).
...
build and (after the fix banked in `.work/archive/todo.md`) a full-4GiB-initial
...
(Before the `.work/archive/todo.md`-logged fix, forcing a kernel build with a FULL
