...
Mandated by `.work/archive/region-arena-design.md` Risks §1: "measure round-liveness
...
micro-kernel**, built once natively from `.work/archive/watr-diff-entry.mjs`'s graph
...
and validate cleanly. Worth a `.work/archive/todo.md` line for whoever next hits
