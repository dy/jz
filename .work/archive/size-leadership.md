...
- `wasm-objdump -x -j Data` on the untouched case: segment[1] is 5560B of
  ...
  tables. `.work/archive/todo.md` (prior session, 2026-07-29, `.work/archive/todo.md:5340`)
  ...
  (`.work/archive/todo.md:5315`, same date): "`__str_concat` was ALREADY stratified
...
- **Fix is already designed and BLOCKED, not open**: the same log records a
  ...
  (`.work/archive/todo.md:5320`). **Do not re-attempt this without first confirming
  ...
  (`.work/archive/todo.md:5321-5323`: `a.name=7;a.shift()` → wrong result,
