...
`.work/archive/todo.md`'s 2026-08-06 entry for the full gate report.
...
- **sort — original flag-veto** (`cfbb23dd`, 2026-07-26, `.work/archive/todo.md:3830`):
...
- **sort — `child+1<n` f64-round-trip regression, and radixsort —
  ...
  `.work/archive/todo.md` "Status (2026-08-05, THREE SPEED REDS DISSECTED…)"), landed as
...
Doc: `.work/archive/rival-wat-analysis.md` (this file).
Ledger pointer: one-line entry appended to `.work/archive/todo.md`, committed
