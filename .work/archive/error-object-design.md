...
Read-only deliverable. User decision (.work/archive/todo.md:704-706, "DECISIONS EXECUTED
...
subset that reads them. Prior investigation (.work/archive/todo.md:886-911, "ERROR-MESSAGE
...
~40B). Full account: `.work/archive/todo.md`'s 2026-08-04 audit-#9 P0-2 entry.
...
bug in either. Full technical account in `.work/archive/todo.md`'s 2026-08-04 entry;
...
Full account: `.work/archive/todo.md`'s 2026-08-04 audit-#10 Error-bundle entry.
...
Full account: `.work/archive/todo.md`'s 2026-08-05 audit-#11 gap-bundle entry.
