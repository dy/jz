...
- `.work/archive/bigint-retirement-design.md` (2026-08-13, 9f851ff0): full 6-slice plan, Table A
...
- Slice 0 partial: 38f1259a (self-host kernel-source rewrite, 11→5 unprovable boxed
  ...
  reverted" — root cause .work/archive/todo.md:10044-10097: retiring the legacy
...
2. Finish slice 0: rewrite the 5 remaining unprovable self-host boxed sites
   (inventory in .work/archive/bigint-retirement-design.md §5; JZ_DBG_BIGINT_STATS=1 counts them).
   ...
   dc6139d9 post-mortem, .work/archive/todo.md:10044+, has the exact break shape), only then touch
...
Census (.work/archive/feature-reach-census.md, 130 real programs, -O3, verdict table):
