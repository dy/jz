...
DECODE" gap class already named in .work/archive/phase-c-unification.md's C1/C2 sections
...
investigation (.work/archive/phase-c-unification.md, CLOSED 2026-08-27) traced and
...
file's own KNOWN-OPEN comment and in .work/archive/phase-c-unification.md).
...
too (already closed by an earlier, unrelated session per
`.work/archive/phase-c-unification.md`). The isolated reduction's own third-layer residual (self-
