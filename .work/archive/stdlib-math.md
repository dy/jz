...
`.work/archive/stdlib-generators.md` (collection.js/typedarray.js) and
`.work/archive/stdlib-string-array.md` (string.js/array.js).
...
1. `a08247bc` — `.work/archive/stdlib-math.md` (this file).
