...
`JZ_DEBUG_HZALL`/`JZ_DBG_SPEC`, §17-§23 of `.work/archive/carrier-representation-design.md`
...
evidence, and the full gate suite are logged in `.work/archive/todo.md`'s
