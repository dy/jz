...
- `.work/archive/walk-count-design.md` §1 ("Site 1 — analyzeBody's 8 traversals") did
...
This is already down from the 8 counted in `.work/archive/walk-count-design.md` §1.1 (dated
...
Order dependencies (from `.work/archive/walk-count-design.md` §1.3, still accurate):
...
`widenLocalTypes` chain — `.work/archive/walk-count-design.md` §1.3 calls this
