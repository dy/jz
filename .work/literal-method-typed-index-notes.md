...
watr-stream worktree .work/streamcode-bug-notes.md for the original hunt).
...
here). Sibling's notes (.work/streamcode-bug-notes.md in watr-stream
worktree) point at bisect7/8/9/10 (all-standalone-functions, no methods) —
