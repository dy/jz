...
Grown through the Shape #5-#9 campaign (`.work/phase-c-unification.md`).
...
`.work/member-callee-binding-write-notes.md` (a sibling branch,
...
through code that campaign history (`.work/phase-c-unification.md`'s Shape
...
special-cases a bare string leaf, per `.work/analyze-traversals.md`'s own
